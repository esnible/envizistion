...
for prefix in det mk mk2 pp pp11 myc rev sig s delay headers pilot egress istio-egressgateway-76d84fb6bf-nwrz4 ppp web auth ing5000 ing5000b pprbac ppv3 rsql is160; do
